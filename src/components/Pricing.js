...
export default function Pricing() {
    ...
    return (
        <div id="pricing" className="isolate overflow-hidden bg-indigo-600 dark:bg-indigo-700">
            ...
            <div className="flow-root bg-white dark:bg-gray-900 pb-24 sm:pb-32">
                <div className="-mt-80">
                        ...
                        <div className="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2">
                            {tiers.map((tier) => {
                                ...
                                return (
                                    <div
                                        key={tier.id}
                                        className="flex flex-col justify-between rounded-3xl bg-white dark:bg-gray-900 p-8 shadow-xl ring-1 ring-gray-900/10 sm:p-10 dark:border dark:border-gray-600"
                                    >
                                        <div>
                                            <h3 id={tier.id} className="text-base font-semibold leading-7 text-indigo-600 dark:text-white">
                                                {tier.name}
                                            </h3>
                                            <div className="mt-4 flex items-baseline gap-x-2">
                                                ...
                                                <span className="text-base font-semibold leading-7 text-gray-600 dark:text-white">
                                                    {frequency.value === 'monthly' ? '/month' : '/year'}
                                                </span>
                                            </div>
                                            <p className="mt-6 text-base leading-7 text-gray-600 dark:text-white">{tier.description}</p>
                                            <ul role="list" className="mt-10 space-y-4 text-sm leading-6 text-gray-600 dark:text-white">
                                        ...
                                        <a
                                            ...
                                            className="mt-8 block rounded-md bg-indigo-600 dark:bg-indigo-700 px-3.5 py-2 text-center text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 dark:hover:bg-indigo-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                        >
                                            Get started today
                                        </a>
                                    </div>
                            ...
                            <div className="flex flex-col items-start gap-x-8 gap-y-6 rounded-3xl p-8 ring-1 ring-gray-900/10 sm:gap-y-10 sm:p-10 lg:col-span-2 lg:flex-row lg:items-center dark:border dark:border-gray-600">
                                <div className="lg:min-w-0 lg:flex-1">
                                    <h3 className="text-lg font-semibold leading-8 tracking-tight text-indigo-600 dark:text-indigo-300">Enterprise</h3>
                                ...
                                <a
                                    href="#"
                                    id="schedule-link"
                                    className="rounded-md px-3.5 py-2 text-sm font-semibold leading-6 text-indigo-600 dark:text-white dark:hover:text-indigo-300 ring-1 ring-inset ring-indigo-200 hover:ring-indigo-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                >
